...
public class TerminalPrinter implements Display {

    private final Map<Card.Rank, String> rankToDisplayedText = Map.of(
            NINE, "9",
            TEN, "10",
            JACK, "J",
            QUEEN, "Q",
    ...
    private final Map<Card.Suit, String> suitToDisplayedText = Map.of(
            HEARTS, "♥",
            DIAMONDS, "♦",
            CLUBS, "♣",
            SPADES, "♠"
    ...
    @Override
    public void display (PublicState publicState) {
    ...
    private void displayTopPartOfTable(int numberOfCards) {
    ...
    private void displayMiddlePartOfTable(
    ...
    private void displayBottomPartOfTable(List<Card> userCards) {
    ...
    private void displayCurrentGameState(GameInfo gameInfo) {
    ...
    private String[] createBattlefield(List<Card> attackingCards, List<Card> defendingCards) {
    ...
    private String[] createCheatSheet() {
    ...
    private String[] createOpponentCards(int numberOfCards) {
    ...
    private String[] createDeck(int numberOfCards, Card trump) {
    ...
    private String[] createVisibleCards(List<Card> cards) {
